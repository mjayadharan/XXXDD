...
namespace dd_stokes
{
  ...
  template <int dim>
  Tensor<2, dim>
  make_tensor(const std::vector<Tensor<1, dim>> &vec, Tensor<2, dim> &res)
  {
  ...
  template <int dim>
  void
  compliance_tensor(const std::vector<Tensor<1, dim>> &vec,
                    double &                           mu,
                    double &                           lambda,
                    Tensor<2, dim> &                   res)
  {
  ...
  void
  mark_interface_faces(const Triangulation<dim> &tria,
